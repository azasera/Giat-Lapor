...
export const fetchMemos = async (userId: string, userRole: 'principal' | 'foundation' | 'admin' = 'principal'): Promise<MemoData[]> => {
  ...
  return data.map((memo: any) => ({
    ...
    mudir_signature_url: memo.mudir_signature_url,
    mudir_stamp_url: memo.mudir_stamp_url,
    mudir_name: memo.mudir_name,
    status: memo.status,
...
export const saveMemoToSupabase = async (memoData: MemoData, userId: string): Promise<MemoData> => {
  ...
  return {
    ...
    mudir_signature_url: finalData.mudir_signature_url,
    mudir_stamp_url: finalData.mudir_stamp_url,
    mudir_name: finalData.mudir_name,
